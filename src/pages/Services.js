                ...
                <div className="container">
                    <div className="services-grid">
                        <div className="service-card" data-service="logo">
                            ...
                            <div className="service-price">Starting at <span>₹219</span></div>
                        ...
                        <div className="service-card" data-service="brand">
                            ...
                            <h3 className="service-title">AI Design</h3>
                            <p className="service-desc">Cutting-edge AI-powered design solutions that combine artificial intelligence with creative expertise for innovative results.</p>
                            <div className="service-features">
                                <ul>
                                    <li><i className="fas fa-check"></i> AI-Generated Concepts</li>
                                    <li><i className="fas fa-check"></i> Smart Design Automation</li>
                                    <li><i className="fas fa-check"></i> Intelligent Variations</li>
                                    <li><i className="fas fa-check"></i> Rapid Prototyping</li>
                                </ul>
                            </div>
                            <div className="service-price">Starting at <span>₹249</span></div>
                            <Link to="/contact" className="service-btn">Get Started</Link>
                        </div>
                        ...
                        <div className="service-card" data-service="creative">
                            ...
                            <div className="service-price">Starting at <span>₹419</span></div>
                            <Link to="/contact" className="service-btn">Get Started</Link>
                        </div>
                        ...
                        <div className="service-card" data-service="collage">
                            ...
                            <div className="service-price">Starting at <span>₹209</span></div>
                            <Link to="/contact" className="service-btn">Get Started</Link>
                        </div>
                        ...
                        <div className="service-card" data-service="greeting">
                            ...
                            <div className="service-price">Starting at <span>₹349</span></div>
                            <Link to="/contact" className="service-btn">Get Started</Link>
                        </div>
                        ...
                        <div className="service-card" data-service="ideas">
                            ...
                            <div className="service-price">Starting at <span>₹449</span></div>
                            <Link to="/contact" className="service-btn">Get Started</Link>
                        </div>

                        <div className="service-card" data-service="video">
                            <div className="card-glow"></div>
                            <div className="service-icon">
                                <i className="fas fa-video"></i>
                            </div>
                            <h3 className="service-title">Video Editing</h3>
                            <p className="service-desc">Professional video editing services that transform raw footage into compelling visual stories for your brand.</p>
                            <div className="service-features">
                                <ul>
                                    <li><i className="fas fa-check"></i> Professional Editing</li>
                                    <li><i className="fas fa-check"></i> Color Correction</li>
                                    <li><i className="fas fa-check"></i> Sound Enhancement</li>
                        ...
                        <div className="service-card" data-service="animation">
                            <div className="card-glow"></div>
                            <div className="service-icon">
                                <i className="fas fa-play-circle"></i>
                            </div>
                            <h3 className="service-title">Animation</h3>
                            <p className="service-desc">Dynamic animations and motion graphics that bring your ideas to life with engaging visual experiences.</p>
                            <div className="service-features">
                                <ul>
                                    <li><i className="fas fa-check"></i> 2D Animation</li>
                                    <li><i className="fas fa-check"></i> Motion Graphics</li>
                                    <li><i className="fas fa-check"></i> Logo Animation</li>
                                    <li><i className="fas fa-check"></i> Explainer Videos</li>
                                </ul>
                            </div>
                            <div className="service-price">Starting at <span>₹349</span></div>
                            <Link to="/contact" className="service-btn">Get Started</Link>
                        ...
                        <div className="service-card" data-service="frontend">
                            <div className="card-glow"></div>
                            <div className="service-icon">
                                <i className="fas fa-code"></i>
                            </div>
                            <h3 className="service-title">Frontend Development</h3>
                            <p className="service-desc">Modern, responsive websites built with cutting-edge technologies for optimal performance and user experience.</p>
                            <div className="service-features">
                                <ul>
                                    <li><i className="fas fa-check"></i> React Development</li>
                            ...
                            <div className="service-price">Starting at <span>₹999</span></div>
                            <Link to="/contact" className="service-btn">Get Started</Link>
                        </div>
                    </div>
                </div>
